...
public partial class DbventaContext : DbContext
{
    ...
    public virtual DbSet<NumeroCorrelativo> NumerosCorrelativos { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("Categoria"); //sin esto realiza la consulta a 'Categorias'

            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C5EEAA73E");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF4834D89AEA2");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107C66AD2F8");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E1C5FAE96");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13269C8A32C");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F768EB7AA48");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D87F5BAB5E");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE43FE9A24");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A64F50F418");
